...
function validarTelefono (){
    ...
    if(found != null){
        ...
        document.getElementById("usuario__telefono").style.borderBottom = "1px solid rgb(222, 222, 222)"
        return true;
    }
}
...
function crearUsuario(){
    ...
    if( validarContrasenia() == true && validarMail() == true && validarTelefono() == true){
